...
const SuperAdminDashboard: React.FC = () => {
  ...
  // Comprehensive stats for superadmin
  const stats = [
    {
      title: "Total Users",
      value: "10,000",
              ...
              <CardContent>
                <div className="space-y-3">
                  {section.items.map((item, itemIndex) => (
                    <div
                      key={itemIndex}
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg border hover:bg-gray-50 transition-colors gap-2 sm:gap-0"
                    >
                      <div className="min-w-0 flex-1">
